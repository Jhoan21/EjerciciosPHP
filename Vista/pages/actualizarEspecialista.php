                            ...
                            <div id="alertas">
                                <?php if(!empty($_GET["respuesta"]) && $_GET["respuesta"] == "correcto"){ ?>
                                    <div class="alert alert-success alert-dismissable">
                                        ...
                                        La informacion del paciente se ha actualizado correctamente. Puede administrar los pacientes desde <a href="adminEspecialista.php" class="alert-link">Aqui</a> .
                                    </div>
                                <?php } ?>
                            ...
                            <?php }else{
                                ...
                                <div class="col-lg-12">
                                    <form role="form" method="post" action="../../Controlador/especialistaController.php?action=editar">
                                        ...
                                        <div class="form-group">
                                            <label>Nombres</label>
                                            <input required value="<?php echo $ObjeEspecialista->getNombre(); ?>" data-toggle="tooltip" title="Sin Signos de puntuación o caracteres especiales" data-placement="top" maxlength="60" id="Nombres" name="Nombres" minlength="2" class="form-control newTooltip" placeholder="Ingrese Sus Nombres Completos">
                                        </div>
                                        <div class="form-group">
                                            <label>Apellidos</label>
                                            <input required value="<?php echo $ObjeEspecialista->getApellido(); ?>" maxlength="60" id="Apellidos" name="Apellidos" minlength="2" class="form-control" placeholder="Ingrese Sus Apellidos Completos">
                                        </div>
                                        <div class="form-group">
